  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "帅气聪明亲亲哥哥", "year": "2000", "date": "04-03"},
        {"type": "节日", "name": "在一起纪念日", "year": "2001", "date": "08-01"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "帅气聪明亲亲哥哥", "year": "2000", "date": "05-06"},
        {"type": "生日", "name": "漂亮可爱亲亲宝贝", "year": "2001", "date": "07-20"},
      ],
    ...
    {
      name: "漂亮可爱亲亲宝贝~",
      id: "oNuPH5oMK9m1NNterp0yMlnrGRZ4",
      useTemplateId: "8ngmKEIFRWdnpthiROl73Sigh0o2XCJNo6VvUo2obBU
",
      province: "吉林",
      city: "长春",
  ...
  // 【推送完成提醒】模板id, 用来看自己有没有发送成功的那个模板
   GALLBACK_TEMPLATE_ID:"8ngmKEIFRWdnpthiROl73Sigh0o2XCJNo6VvUo2obBU
",
  
  // 接收成功回调消息的微信号，（一般来说只填自己的微信号, name填不填无所谓）
  CALLBACK_USERS: [oNuPH5oMK9m1NNterp0yMlnrGRZ4
    {
      // 一般都填自己
      name: "自己",
  ...
  SLOT_LIST: ["encourage_oneself"
    // 这样配置的话，就会每次发送这句话
    {"keyword": "encourage_oneself", contents: "申请成为你爱里的永久居民。"},
    // 这样配置的话，就会每次随机选一句话发送
